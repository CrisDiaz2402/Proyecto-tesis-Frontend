<template>
  <div class="p-8">
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-400 text-sm mt-1">Elige la combinación de motores de IA que usará el Avatar. Cada modo tiene un balance distinto de privacidad, velocidad y calidad.</p>
    </div>

    <div class="bg-gray-800 border border-gray-700 rounded-xl overflow-hidden max-w-4xl shadow-lg">
      <div class="px-6 py-4 border-b border-gray-700 flex items-center gap-2">
        ...
        <h2 class="text-sm font-semibold text-white uppercase tracking-wider">Modo de Inferencia RAG</h2>
      </div>
...
// El ID del modo seleccionado: 'local:local' | 'cloud:cloud' | 'local:cloud'
const modoSeleccionado = ref<string>('local:local')
const cargando  = ref(true)
const guardando = ref(false)

// ── Helpers de color por modo ────────────────────────────────────────────────
