<template>
  <div class="w-full h-screen bg-gray-100 relative select-none">
    ...
    <div class="absolute top-0 left-0 right-0 sm:right-auto sm:top-5 sm:left-5 z-10 flex flex-col gap-2 sm:gap-4 w-full sm:w-96 p-3 sm:p-0">
      ...
      <div class="bg-white/95 p-3 sm:p-4 rounded-xl shadow-2xl border border-gray-200 backdrop-blur-sm">
        <div class="flex flex-col gap-2 sm:gap-3">
          ...
          <div class="flex gap-2 items-stretch">
            <input
              ...
              class="flex-1 px-3 py-2 bg-gray-50 text-gray-800 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            />
            ...
            <button
              ...
              :class="[
                ...
                store.estaEscuchando ? 'bg-red-500 animate-pulse ring-2 ring-red-400' : 'bg-gray-200 hover:bg-gray-300'
              ]"
            >
          <Icon icon="mdi:microphone" class="text-gray-700 text-xl" />
            </button>
      ...
      <div class="flex gap-2 flex-wrap">
        ...
        <span v-else class="px-2 py-1 bg-gray-100 text-gray-500 text-xs rounded border border-gray-200">
          En espera
        </span>
...
const enviarPregunta = (textoDirecto?: string): void => {
  ...
  try {
    ...
    console.error('[AvatarView] send error:', errMsg)
    store.setCargando(false)
